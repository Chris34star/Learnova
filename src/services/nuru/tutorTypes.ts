export type NuruMode='learning'|'practice'|'assessment'|'review'|'explore';
...
export interface NuruRequest {question:string;interactionType:NuruInteractionType;courseId?:string;contentNodeId?:string;assessmentAttemptId?:string;questionId?:string;recommendationTargetId?:string;hintLevel?:number}
